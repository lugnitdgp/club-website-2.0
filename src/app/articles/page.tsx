...
function ArticlesPage() {
  ...
  if (isLoading) return <DataLoader text="Loading Articles data..." />;
  if (error)
    return (
      <div className=" h-[70vh] w-screen text-center">Error loading the Articles data.</div>
    );
  if (!data)
    return <div className=" h-[70vh] w-screen text-center">No Articles data found.</div>;
