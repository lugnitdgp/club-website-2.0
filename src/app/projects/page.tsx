          ...
          <Modal key={project.id}>
            <ModalTrigger className="w-full h-full">
              <CardContainer className="inter-var w-full h-full">
                <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-full min-h-[520px] rounded-xl p-6 border flex flex-col">
                  {/* Title - Fixed Height and Left Aligned */}
                  <CardItem
                    translateZ="50"
