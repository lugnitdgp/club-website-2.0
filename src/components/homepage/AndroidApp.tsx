...
function AndroidApp() {
  return (
    <div className="md:h-[50vh] h-[70vh] w-[90%] md:w-4/5 mx-auto bg-gradient-to-r from-purple-200 to-purple-100 dark:from-[#0f1724] dark:to-[#1a2035] rounded-[5rem] relative overflow-hidden shadow-md transition-colors duration-300">
      <div className="flex flex-col items-center md:justify-center absolute z-10 h-full w-full md:w-3/5 text-center pt-16 md:pt-0">
        ...
        <p className="text-md font-medium text-gray-700 dark:text-gray-300 mt-2 w-4/5 md:w-max">
