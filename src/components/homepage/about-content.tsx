...
export const content: ContentItem[] = [
  {
    ...
    content: (
      <div className="h-full w-full rounded-md flex items-center justify-center bg-white dark:bg-neutral-800 p-4">
        <img
          src="https://res.cloudinary.com/dogqbjx8a/image/upload/WhatsApp_Image_2025-03-09_at_16.21.35_jtfaxn.jpg"
          alt="Who We Are"
  ...
  },
  {
    ...
    content: (
      <div className="h-full w-full rounded-md flex items-center justify-center bg-white dark:bg-neutral-800 p-4">
        <img
          src="https://res.cloudinary.com/dogqbjx8a/image/upload/WhatsApp_Image_2025-03-09_at_16.23.55_zpdzkp.jpg"
          alt="What We Do"
          className="max-w-full max-h-full object-contain rounded-lg"
        />
      </div>
  ...
  },
  {
    ...
    content: (
      <div className="h-full w-full rounded-md flex items-center justify-center bg-white dark:bg-neutral-800 p-4">
        <img
          src="https://res.cloudinary.com/dogqbjx8a/image/upload/WhatsApp_Image_2025-03-09_at_10.27.30_ugugge.jpg"
          alt="Our Vision"
          className="max-w-full max-h-full object-contain rounded-lg"
        />
      </div>
...
export const socialLinks = [
  { name: "Facebook",  icon: "Facebook",      url: "https://www.facebook.com/nitdgplug" },
  { name: "Gitter",    icon: "MessageCircle", url: "https://gitter.im/lugnitdgp" },
  { name: "YouTube",   icon: "Youtube",       url: "https://www.youtube.com/channel/UCYZPnN5vP5B1sINLLkI1aDA" },
  { name: "GitHub",    icon: "Github",        url: "https://github.com/lugnitdgp" },
  { name: "Instagram", icon: "Instagram",     url: "https://www.instagram.com/nitdgplug" },
  { name: "Email",     icon: "Mail",          url: "mailto:contact@nitdgplug.org" },
  { name: "LinkedIn",  icon: "Linkedin",      url: "https://in.linkedin.com/company/lugnitdgp" },
  { name: "Dev.to",    icon: "Code",          url: "https://dev.to/nitdgplug" },
];