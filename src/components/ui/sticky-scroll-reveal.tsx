...
export const StickyScroll = ({
  ...
  const backgroundColors = [
    "rgba(255, 239, 213, 0.2)", // light orange with 40% opacity
    "rgba(255, 182, 193, 0.2)", // light pink with 40% opacity
    "rgba(255, 255, 224, 0.2)", // light yellow with 40% opacity
  ];
          ...
          {content.map((item, index) => (
            <div key={item.title + index} className="my-20">
              <motion.h2
                ...
                className="text-2xl font-bold dark:text-slate-100 text-black"
              >
                {item.title}
              </motion.h2>
              <motion.p
