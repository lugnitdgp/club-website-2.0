...
function Navbar({}: Props) {
  return (
    <>
      ...
      <motion.nav className="fixed flex flex-col items-center justify-center  h-screen px-4 md:flex bg-pinkSecondary dark:bg-surfaceDark">
        <div className="flex flex-col items-center space-y-4">
          ...
          {icons.map((icon, index) => {
            return <IconComponent key={index} icon={icon} />;
          })}
        </div>
        {/* <ThemeSwitcher /> */}
      </motion.nav>
